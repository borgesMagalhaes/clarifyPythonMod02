...
dados_conceitos ={ # dicionarios com AS INFORMAÇÕES DA CAIXA DROPDOWN
    ...
    'sql' :    {'variaveis':7,'condicionais':10 , 'loops' : 9 , 'poo':8 ,'funções':4},
    'golang' : {'variaveis':10,'condicionais':5, 'loops' : 8 , 'poo':4 ,'funções':3},
    'javascript' : {'variaveis':9,'condicionais':7, 'loops' : 5 , 'poo':6 ,'funções':8}
}
